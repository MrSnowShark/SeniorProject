...
var entityPath = createPath(positionProperty); // Creating a path called entityPath
var modelEntity = createModel('./assets/data/Cessna172.glb', positionProperty, orientationProperty); // Creating a model called modelEntity
/*
